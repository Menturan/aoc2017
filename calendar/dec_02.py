...
spreedsheet = '''409	194	207	470	178	454	235	333	511	103	474	293	525	372	408	428
...
3858	202	1141	3458	2507	239	199	4400	3713	3980	4170	227	3968	1688	4352	4168'''.split(
    sep='\n')
for idx, line in enumerate(spreedsheet):
    line = line.split(sep='\t')
    line = list(map(int, line))
    spreedsheet[idx] = line
